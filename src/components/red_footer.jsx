    ...
    <>
      <div className="flex flex-col md:flex-row justify-center md:justify-between m-auto p-8 md:p-14 lg:p-20 red-footer-bg gap-8">
        <div className="flex flex-col gap-4 p-4">
          ...
          <p className="text-lg  md:text-xl lg:text-2xl font-semibold font-canarobook text-white">
            +233 (050) 900-1207
          </p>
          <a
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="flex flex-row gap-2 mt-4">
            ...
            <a href="https://www.tiktok.com/@georgetwumba?_t=8o9dQLG6nGn&_r=1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="https://www.instagram.com/georgetwumba/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="https://www.facebook.com/GeorgeTwumBA/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="https://x.com/GeorgeTwumBA">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
