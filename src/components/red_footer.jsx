...
export default function RedFooter(){
  return(
    <>
      <div className="z-10 flex flex-col lg:flex-row md:flex-row justify-between items-center p-8 red-footer-bg gap-4">
        <div className="ml-4 lg:ml-12 md:ml-12 flex flex-row gap-2">
