...
export default function RedFooter(){
  return(
    <>
      <div className="z-10 grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 m-auto justify-between p-20 red-footer-bg gap-4">
        <div className="flex flex-col gap-4 p-8">
          <h1 className="contact-header">contact our campaign</h1>
          <p className="contact-p-sub">P.O. Box 123456<br />Street name, Accra</p>
          <p className="contact-header">(+233) 244 509 113</p>
          <a href="mailto:email@gmail.com" className="contact-p-sub">email@gmail.com</a>
        </div>
      ...
      <div className="red-footer-bg-alt"></div>
      <div className="red-footer-bg flex justify-center items-center m-auto h-12">
        <p className="text-white">&copy; 2024 Breakingthe2 | All rights reserved. | Contributions or gifts to Campaign Name are not tax deductable.</p>
      </div>
    </>
  )
}