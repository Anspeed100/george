          ...
          <div className="mx-auto px-2 sm:px-6 lg:px-8 h-24">
            <div className="relative grid grid-cols-4 items-center justify-between h-16">
              <div className="absolute inset-y-0 right-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="z-30 inline-flex items-center justify-center mt-4 rounded-md text-black focus:outline-none ring-2 ring-inset ring-black">
                  <span className="sr-only">Open main menu</span>
                  {open ? (
                    <XIcon className="block h-9 w-9 text-white" aria-hidden="true" />
                  ) : (
