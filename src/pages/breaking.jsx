    ...
    <div className="relative">
      ...
      <div className="manifesto-bg">
        <div className="flex flex-col gap-8 justify-center items-center m-auto p-8">
          <img src={RevealImg} className="w-2/5"/>
          {
            isLoading ?
            <Loader/>
            :
        ...
        <div className="flex flex-col gap-8 justify-center items-center m-auto p-8">
          {
            ...
            <Loader/>
            :
            <h1 className="manifesto-p manifesto-p-alt w-3/5 scrollable-div">
      ...
      <div className="manifesto-bg">
        <div className="flex flex-row gap-4 justify-between items-center pl-12 pr-24">
          <img src={Assets15Img} className="w-20"/>
      ...
      <div className="flex flex-col p-8 mt-8">
        ...
        <div className="p-12 flex flex-col justify-start items-start">
          <h1 className="manifesto-header pl-24">My Pledge</h1>
          <div className="flex justify-center items-center">
            <h1 className="manifesto-p manifesto-p-alt w-3/5 scrollable-div">
      ...
      <div className="manifesto-bg flex flex-col p-8 mt-8">
        <div className="p-12 flex flex-col justify-start items-start m-auto">
          <h1 className="manifesto-header manifesto-header-sub pl-24">The Flag</h1>
          <div className="flex flex-col justify-center items-center m-auto">
            <h1 className="manifesto-p w-3/5">
