      ...
      <div className="relative mt-8 sm:mt-16">
        <div className="flex flex-col items-center">
          {roadmapData.map((item, index) => (
            <motion.div
              key={index}
              className="flex items-center w-11/12 md:w-3/4 lg:w-1/2 mb-8"
            ...
            >
              ...
              <div className="relative flex flex-col items-center">
                <div className="h-32 w-1 bg-red-500"></div> {/* Set a fixed height here */}
              ...
              <div className={`flex flex-col md:flex-row items-center shadow-md rounded-lg p-6 w-full ${item.backgroundColor}`}>
                ...
                <div className="flex flex-col items-center text-center md:text-left flex-grow">
                  <h2 className="text-2xl sm:text-xl font-canarobold">{item.title}</h2>
                  <p className="text-gray-600 font-canarobook">{item.description}</p>
