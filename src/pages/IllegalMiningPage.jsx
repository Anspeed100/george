...
const IllegalMiningPage = () => {
  return (
    <div className="min-h-screen bg-white pt-32">
      <header className="bg-[#BA2026] h-32 flex items-center px-4">
        <h1 className="text-white font-bold text-4xl">ILLEGAL MINING: A FAILURE OF OUR CURRENT DEVELOPMENTAL MODEL.</h1>
      </header>
...
export default IllegalMiningPage