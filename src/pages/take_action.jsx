      ...
      <div className="grid grid-cols-2 gap-4 relative lg:hidden md:hidden">
        ...
        <div className="container take-action-page take-action-page-red z-0 flex flex-col gap-1 items-end relative">
          <div className="flex flex-col gap-2 justify-center items-end z-10 take-action-pos">
            ...
            <p className="take-p take-p-color z-10">Be a part of the Team George Volunteers who believe in #Breakingthe2 to create Common Prosperity and alland make Ghana great.</p>
            <div className="flex justify-end">
            <a href="#" spy={true} smooth={true} className={"button-primary-alt button-primary button-primary-mobile-d"}>
        ...
        <div className="container take-action-page z-0 flex flex-col gap-1 items-end relative">
          <div className="flex flex-col gap-2 justify-start take-action-pos">
            <h1 className="header-text-sub header-text-sub-alt-2 ml-2">Adopt An Electoral Area</h1>
            <p className="take-p take-p-alt ml-2">Be part of the Grass Root Campaign by adopting one or many Electoral Areas and support them with your Ideas, Time and Resources.</p>
