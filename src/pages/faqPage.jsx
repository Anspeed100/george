...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "After 32 years of NDC and NPP rule, I have come to the conclusion that they are leading us nowhere but down a rabbit hole! <br/><br/>I have voted NDC and NPP, hoping that they knew what they were doing. I have now come to the realization that truly the two parties are incapable of managing and developing the nation to deliver prosperity for all. A case in point, is the fact that every one of these administrations, be it of NDC or NPP stock, has gone, cup in hand, to the IMF since 1995. I ask: if they knew the way to real economic growth and prosperity, would they not have shown same, and would we not have witnessed those capabilities after all these terms in office? <br/><br/> Since 1992, there have been so many promises that both the NDC and the NPP have made, conning us into believing them, and then failing to deliver! <br/><br/> It is quiet sad that after thirty-two years of NDC and NPP rule and borrowing over 600 Billion Ghana Cedis, one tomato today sells for 5 Ghana Cedis, a ball of Kenkey sells for 6 Ghana Cedis and unemploymnet is hovering around 14 per cent. Yet they have come back again asking for four more years.  It is either the two parties take us for granted or they take us for ‘fools’.<br/><br/> At the moment the only thing that differentiates the NDC from the NPP, is their party name, party colours and party symbol.<br/><br/> I am of the firm belief that the time has come, – for us to seize our destiny – to take the bull by the horns and beat our own path to rapid development. To shake off the shackles of our underdevelopment and give birth to a new Ghana that takes its rightful place in the comity of nations as the great power it should have been by now - and of that new Ghanaian who, with a revitalized mindset and sense of purpose, strives to create the Ghana we all wish to see. A Ghana that posterity will salute us for! This much, we have to see to ourselves! No one will do it for us!<br/><br/> This, precisely, is why I have decided to be a presidential candidate in this year’s presidential election. To serve you, the good people of Ghana, as President of the Republic. I am doing this because I fervently believe it is time to forge a brighter future for every Ghanaian and not only for those who belong to the political party of the President in power. And to change the Growth Oriented Development (GOD) Model practised by both the NDC and NPP for the last thirty-two years to People Oriented Development (POD) Model with emphasis on people development and growth.<br/><br/> Article 57 of the 1992 Constitution states, “There shall be a President of the Republic of Ghana who shall be the Head of State and Head of Government and Commander-In-Chief of the Armed Forces of Ghana.”<br/><br/> However, since the onset of the fourth Republic, we have had Presidents who have replaced the constitutional logic of a “Head of State” with the fearful use, in reality, of a “Head of Party,” instead.<br/><br/> These and more, account for why I have decided to seek the High Office of President, to truly serve you as Head of State, Head of Government and Commander-in-Chief of the Armed Forces of Ghana. I will be a Head of State for the people! One who brings about destiny-changing transformation!<br/><br/> The time has come for you and I to make true the statement by Ghana’s first President, Osagyefo Dr. Kwame Nkrumah that the Black Man is capable of managing his own affairs.",
    backgroundColor: "bg-[#009845]",
    textColor: "text-[#fff]",
  },
  {
