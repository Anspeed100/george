        ...
        <div className="relative mb-">
          <div className="lg:flex md:flex flex-col relative mt-8">
            <div className="flex flex-col md:flex-row mt-10">
              <div className="object-fill flex flex-1">
                <img src={ClientImg} alt="Candidate" className="z-10 w-full h-auto max-h-[80vh] object-cover" />
              </div>
              <div className="flex flex-1 flex-col gap-2 justify-start m-auto p-12 z-10">
                ...
                <h1 className="text-start font-canarobook md:text-2xl text-center">
                  ...
                  God bless Ghana, our Motherland, and make Her Great
          ...
          <div className="flex flex-col md:flex-row md:h-[35rem] mt-10">
            ...
            <div className="flex flex-1 flex-col justify-center items-center p-4">
              ...
              <h1 className="text-start p-4 font-canarobook md:text-2xl text-center">
          ...
          <div className="relative flex flex-col justify-center items-center overflow-hidden">
            <div className="bg-hidden md:bg-black md:w-40 md:h-40 md:absolute md:top-[5%] md:left-[10%] rounded-md fadein" data-parallax data-speed="0.1"></div>
            <div className="bg-hidden md:bg-[#009844] md:w-56 md:h-56 md:absolute md:bottom-[15%] md:left-[8%] rounded-md fadein" data-parallax data-speed="0.1"></div>
            <div className="bg-hidden md:bg-[#ec1c24] md:w-64 md:h-64 md:absolute top-[20%] right-[8%] rounded-md fadein" data-parallax data-speed="0.1"></div>
            <div className="bg-hidden md:bg-[#b5a232] md:w-96 md:h-96 md:absolute md:bottom-[15%] md:right-[2%] rounded-md fadein" data-parallax data-speed="0.1"></div>
